		...
		parte4_q5: //Questão 5
		{
			...
			[
				{//A
					...
					associado: true,					
					msgErro: "Você pode trabalhar com as linhas (ou colunas) de cada matriz, verificando quais vértices estão ligados a quais outros. Se você preferir, pode analisar cada voo individualmente e construir os segmentos de vértice <span style='font-style: italic'>i</span> e <span style='font-style: italic'>j</span> correspondentes às entradas (i,j) da matriz que estiverem preenchidos com 1's."
				},
				{//B
					tipo: 'instrucao',
